...
export default function Content(props) {
    ...
    const handleSubmit = async (e, id) => {
        ...
        e.preventDefault();
        const response = await fetch(`https://techmate-backend.onrender.com/api/answer/addanswer/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const upvoteQue = async (e, id) => {
        ...
        if (localStorage.getItem("username") !== null) {
            ...
            const response = await fetch(`https://techmate-backend.onrender.com/api/question/upvote/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const downvoteQue = async (e, id) => {
        ...
        if (localStorage.getItem("username") !== null) {
            ...
            const response = await fetch(`https://techmate-backend.onrender.com/api/question/downvote/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const fetchQueVotes = async (id) => {
        ...
        const response = await fetch(`https://techmate-backend.onrender.com/api/question/fetchVotes/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const addComment = async (e, id) => {
        ...
        const response = await fetch(`https://techmate-backend.onrender.com/api/comment/addcomment/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const fetchComments = async (id) => {
        await fetch(`https://techmate-backend.onrender.com/api/comment/fetchComments`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            },
